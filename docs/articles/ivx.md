...
[`summary`](https://rdrr.io/r/base/summary.html)`(``mod``)`\
`#> `\
`#> Call:`\
...
[`delta`](https://kvasilopoulos.github.io/ivx/reference/delta.md)`(``mod``)`\
...
\
[`coef`](https://rdrr.io/r/stats/coef.html)`(`[`ivx`](https://kvasilopoulos.github.io/ivx/reference/ivx.md)`(``Ret`` ``~`` ``DP`` ``+`` ``TBL``, data ``=`` ``kms``, beta ``=`` ``0.9``, cz ``=`` ``5``, bandwidth ``=`` ``10``)``)`\
`#>          DP         TBL `\
...
\
[`summary`](https://rdrr.io/r/base/summary.html)`(`[`ivx`](https://kvasilopoulos.github.io/ivx/reference/ivx.md)`(``Ret`` ``~`` ``DP`` ``+`` ``TBL``, data ``=`` ``kms``, horizon ``=`` ``12``)``)`\
`#> `\
`#> Call:`\
...
\
[`summary`](https://rdrr.io/r/base/summary.html)`(`[`ivx`](https://kvasilopoulos.github.io/ivx/reference/ivx.md)`(``Ret`` ``~`` ``DP`` ``+`` ``TBL``, data ``=`` ``kms``, robust ``=`` ``TRUE``)``)`\
`#> `\
`#> Call:`\
...
\
`m6`` ``<-`` `[`ivx`](https://kvasilopoulos.github.io/ivx/reference/ivx.md)`(``Ret`` ``~`` ``DE``, data ``=`` ``kms``)`\
[`c`](https://rdrr.io/r/base/c.html)`(``coef ``=`` `[`round`](https://rdrr.io/r/base/Round.html)`(`[`coef`](https://rdrr.io/r/stats/coef.html)`(``m6``)``, ``4``)``, wald ``=`` `[`round`](https://rdrr.io/r/base/Round.html)`(``m6``$``Wald_Ind``, ``3``)``, delta ``=`` `[`round`](https://rdrr.io/r/base/Round.html)`(`[`delta`](https://kvasilopoulos.github.io/ivx/reference/delta.md)`(``m6``)``, ``3``)``)`\
`#> coef.DE wald.DE   delta `\
`#> -0.0033  0.3930 -0.0670`\
`# paper: -0.0033, 0.393, -0.067`\
\
`m8`` ``<-`` `[`ivx`](https://kvasilopoulos.github.io/ivx/reference/ivx.md)`(``Ret`` ``~`` ``DP`` ``+`` ``TBL``, data ``=`` ``kms``)`\
[`c`](https://rdrr.io/r/base/c.html)`(`[`round`](https://rdrr.io/r/base/Round.html)`(`[`coef`](https://rdrr.io/r/stats/coef.html)`(``m8``)``, ``4``)``, joint ``=`` `[`round`](https://rdrr.io/r/base/Round.html)`(``m8``$``Wald_Joint``, ``3``)``)`\
`#>      DP     TBL   joint `\
...
\
`h`` ``<-`` `[`c`](https://rdrr.io/r/base/c.html)`(``4``, ``12``, ``24``, ``36``, ``48``, ``60``)`\
`t13`` ``<-`` `[`t`](https://rdrr.io/r/base/t.html)`(`[`sapply`](https://rdrr.io/r/base/lapply.html)`(``h``, ``function``(``k``)`` ``{`\
`  ``m`` ``<-`` `[`ivx`](https://kvasilopoulos.github.io/ivx/reference/ivx.md)`(``Ret`` ``~`` ``EP`` ``+`` ``TBL``, data ``=`` ``kms``, horizon ``=`` ``k``)`\
`  `[`c`](https://rdrr.io/r/base/c.html)`(``EP ``=`` ``m``$``Wald_Ind``[[``"EP"``]``]``, TBL ``=`` ``m``$``Wald_Ind``[[``"TBL"``]``]``, joint ``=`` ``m``$``Wald_Joint``)`\
`}``)``)`\
[`round`](https://rdrr.io/r/base/Round.html)`(`[`cbind`](https://rdrr.io/r/base/cbind.html)`(``horizon ``=`` ``h``, ``t13``)``, ``3``)`\
