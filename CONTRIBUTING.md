...
This outlines how to propose a change to ivx. For more detailed info
...
Please note that the ivx project is released with a [Contributor Code of
Conduct](https://kvasilopoulos.github.io/ivx/CODE_OF_CONDUCT.md). By
